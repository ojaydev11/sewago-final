...
export const env = {
    ...
    accessTokenSecret: process.env.JWT_ACCESS_SECRET ?? "insecure_dev_access_secret_change_me",
    refreshTokenSecret: process.env.JWT_REFRESH_SECRET ?? "insecure_dev_refresh_secret_change_me",
